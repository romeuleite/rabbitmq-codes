  ...
  try {
    ...
    channel.consume(queueResult.queue, (msg) => {
      if (msg !== null) {
        ...
        const reply_exchange = 'AsubBresponse';
        channel.assertExchange(reply_exchange, 'direct', { durable: false });
        const operation = 'response';
        channel.publish(reply_exchange, operation, Buffer.from(result.toString()));
